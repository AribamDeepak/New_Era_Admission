    ...
    <div align="center" style="color:#656565;"><h2 style="font-family:'open sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;font-weight: 400;text-align: center;">RECEIPT</h2></div>
					...
					<table class="table" style="width:100%;font-family:'open sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:13px;" >
						<tr>
							<td><b>Bill to<b></td>
								...
								<tr>
									<td style="width:50%">
									<p style="margin-bottom:10px;">	Name:<?php echo $result['student_details'][0]['student_name']?> <p>
									
										<p style="margin-bottom:10px;"> Mobile: <?php echo $result['student_details'][0]['watsapp_no']?> </p>
										
										<p style="margin-bottom:10px;"> Registration ID: 
                                       <?php echo $result['student_details'][0]['application_id']?>
                                        </p>
										<p style="margin-bottom:10px;"> Address: 
                                       <?php echo $result['student_details'][0]['permanent_address']?>
                                        </p>
								...
								<table style="width:100%;font-family:'open sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:13px;" >
									<tr>
										<td>
										Receipt No : </td><td ><?php echo $result['invoice_no'];?></td><td>	Date/Time : </td><td>
										<?php $date = new DateTime( $result['added_on'], new DateTimeZone("UTC") );
				...
				echo $date->format("d M Y, D h:i A");?>
								...
								<table class="table" style="width:100%;font-family:'open sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:13px;" > 
									...
									foreach($result['fees_payment_details'] as $row){
									?>
									<tr>
										<td ><?php echo $slno;?></td>
										<td class=""> 
...
<div style="text-align:right">
		  ...
		  <button type="button" class="btn btn-danger" onclick="show_payment_history_modal(<?php echo $result['student_details'][0]['id']?>)">Close</button>						
</div>